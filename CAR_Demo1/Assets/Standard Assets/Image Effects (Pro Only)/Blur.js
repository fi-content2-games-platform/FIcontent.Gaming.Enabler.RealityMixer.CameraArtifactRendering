...
class Blur extends PostEffectsBase {
	...
	@Range(0.0f, 10.0f)
	public var blurMul : float = 3.0f;
	
	@Range(1, 4)
	public var blurIterations : int = 2;
	
	@Range(0, 1)
	public var blurStabilizer : float = 0.5;
	...
	function OnRenderImage (source : RenderTexture, destination : RenderTexture) {	
		...
		camVel = (camPosOld - camTrans.position).magnitude;
		camPosOld = camTrans.position;
		blurSize = blurMul*camVel*(1-blurStabilizer) + blurStabilizer*blurSize;
