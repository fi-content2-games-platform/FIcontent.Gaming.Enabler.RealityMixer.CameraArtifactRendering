...
public class CameraMotionBlur extends PostEffectsBase 
{
	...
	//public var blurMul : float = 1.0f;
	//public var blurStabilizer : float = 0.5f;	
	//private var camPosOld : Vector3;	
	//private var camVel : Vector3;
	
	//function OnGUI()
	//{
	//	GUI.Label(Rect(0,0,300,100), camVel + "");
	//}
	
	
	public var hello : float;
	@Range(0, 1)
	public var stabilizer : float = 0.5f;
	...
	private var oldBlurVector : Vector3;
	...
	function OnRenderImage (source : RenderTexture, destination : RenderTexture) {	
		...
		//fabio
		//camVel = (camPosOld - camTrans.position);
		////camPosOld = camTrans.position;
		//var blurDirSize : Vector3 = blurMul*camVel*(1-blurStabilizer) + blurStabilizer*camVel;
		...
		if (filterType == MotionBlurFilter.CameraMotion)
		{
			...
			// fabio: temporal stability!
			blurVector = blurVector*(1-stabilizer) + oldBlurVector*stabilizer;
			oldBlurVector = blurVector;
